 ...
 */
class Usuario extends \Caog\HorariosBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Usuario' . "\0" . 'nombre', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Usuario' . "\0" . 'apellidos', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Usuario' . "\0" . 'edad', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Usuario' . "\0" . 'pais', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Usuario' . "\0" . 'departamento', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Usuario' . "\0" . 'ciudad', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Usuario' . "\0" . 'localidad', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Usuario' . "\0" . 'direccion', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Usuario' . "\0" . 'id'];
        }
