...
class Empresa extends \Caog\HorariosBundle\Entity\Empresa implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Empresa' . "\0" . 'nombre', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Empresa' . "\0" . 'pais', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Empresa' . "\0" . 'departamento', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Empresa' . "\0" . 'ciudad', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Empresa' . "\0" . 'localidad', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Empresa' . "\0" . 'direccion', '' . "\0" . 'Caog\\HorariosBundle\\Entity\\Empresa' . "\0" . 'id'];
        }
