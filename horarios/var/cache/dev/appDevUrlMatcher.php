    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/empresa')) {
            ...
            if (0 === strpos($pathinfo, '/empresa/actividad')) {
                ...
                if (0 === strpos($pathinfo, '/empresa/actividad/getActividadEmpresa')) {
                    ...
                    if ($pathinfo === '/empresa/actividad/getActividadEmpresa') {
                        return array (  '_controller' => 'Caog\\HorariosBundle\\Controller\\ActividadEmpresaController::getActividadEmpresaAction',  '_route' => 'caog_horarios_empresa_actividad_getActividadEmpresa',);
                    }
