 ...
 */
class ActividadEmpresa extends \Caog\HorariosBundle\Entity\ActividadEmpresa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'nombre', 'tipo', 'prioridad', 'pais', 'departamento', 'ciudad', 'localidad', 'direccion', 'empresa'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ActividadEmpresa $proxy) {
