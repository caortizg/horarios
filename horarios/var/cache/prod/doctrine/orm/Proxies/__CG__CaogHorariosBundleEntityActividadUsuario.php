 ...
 */
class ActividadUsuario extends \Caog\HorariosBundle\Entity\ActividadUsuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'nombre', 'tipo', 'prioridad', 'pais', 'departamento', 'ciudad', 'localidad', 'direccion'];
        }
